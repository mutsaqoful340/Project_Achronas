...
public class _GP_RadialQTE_PointerCollider : MonoBehaviour
{
    [Tooltip("Reference ke _GP_RadialQTE parent")]
    public _GP_RadialQTE radialQTE;
    ...
    private void Awake()
    {
        ...
        if (radialQTE == null)
        {
            radialQTE = GetComponentInParent<_GP_RadialQTE>();
        }
