...
public class _GP_RadialQTE_Manager : MonoBehaviour
{
    [Header("Radial QTE Instances")]
    public _GP_RadialQTE radialQTE1;
    public _GP_RadialQTE radialQTE2;
    ...
    /// </summary>
    private void OnQTEButtonPressed(_GP_RadialQTE qte, string pressedButton)
    {
